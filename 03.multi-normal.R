...
X2 <- data.frame(paste(X1$V1, X1$V2, X1$V3, X1$V4, X1$V5, X1$V6, X1$V7, sep = ":")) #X1$V1, X1$V2, X1$V4, X1$V5, X1$V6
X2[,2] <- 1
dim(X2)
...
X2 <- data.frame(paste(X1$V1, X1$V2, X1$V3, X1$V4, X1$V5, X1$V6, X1$V7, sep = ":"))
X2[,2] <- 1
colnames(X2) <- c("SNP",j)
print(dim(X2))
X <- merge(X, X2, by="SNP")
